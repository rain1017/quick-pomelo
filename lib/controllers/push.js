...
proto.joinAsync = function(channelId, playerId, connectorId){
	...
	.then(function(){
		return P.bind(this)
		.then(function(){
			return models.Channel.findLockedAsync(channelId);
		})
	...
	.then(function(ret){
		return P.bind(this)
		.then(function(){
			return models.PlayerChannel.findLockedAsync(playerId);
		})
...
proto.pushAsync = function(channelId, playerIds, route, msg, persistent){
	...
	return P.bind(this)
	.then(function(){
		return this.app.models.Channel.findLockedAsync(channelId);
	})
	.then(function(channel){
		if(!channel){
			throw new Error('channel ' + channelId + ' not exist');
