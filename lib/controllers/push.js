...
proto.join = function(channelId, playerId, connectorId){
	...
	.then(function(){
		return P.bind(this)
		.then(function(){
			return models.Channel.findByIdForUpdateAsync(channelId);
		})
	...
	.then(function(ret){
		return P.bind(this)
		.then(function(){
			return models.PlayerChannel.findByIdForUpdateAsync(playerId);
		})
...
proto.push = function(channelId, playerIds, route, msg, persistent){
	...
	return P.bind(this)
	.then(function(){
		return this.app.models.Channel.findByIdForUpdateAsync(channelId);
	})
	.then(function(channel){
		if(!channel){
			throw new Error('channel ' + channelId + ' not exist');
...
proto.getMsgs = function(channelId, seq, count){
	...
	return P.bind(this)
	.then(function(){
		return this.app.models.Channel.findByIdAsync(channelId);
	})
	.then(function(channel){
		if(!channel){
			throw new Error('channel ' + channelId + ' not exist');
