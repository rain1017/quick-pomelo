...
proto.quitArea = function(playerId, opts){
	...
	return Q.fcall(function(){
		...
		areaId = ret;
		if(areaId === null && !opts.ignoreNoArea){
...
proto.login = function(playerId, connectorId){
	return this.invokePlayer(playerId, 'login', connectorId);
};

proto.logout = function(playerId){
	return this.invokePlayer(playerId, 'logout');
};
