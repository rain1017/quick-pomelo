...
proto.joinDefaultArea = function(playerId, retries){
	...
	return Q.fcall(function(){
		return self.app.playerManager.joinArea(playerId, areaId);
	}).then(function(){
...
proto.refreshStatistics = function(){
	...
	var Model = self.app.areaManager.getAreaModel('default');
...
proto.allocateArea = function(){
	...
	return Q.allSettled(_.range(newCount).map(function(){
		return Q.fcall(function(){
			...
			return self.app.areaManager.createArea(opts, 'default');
...
proto.recycleArea = function(){
	...
	return Q.allSettled(areasToRemove.map(function(area){
		var areaId = area._id;
		return Q.fcall(function(){
			return self.app.areaManager.removeArea(areaId);
		}).then(function(){
