...
proto.reportServerStatus = function(){
	...
	return Q.fcall(function(){
		...
		return Q.ninvoke(app.rpc.autoscaling.reportRemote, 'reportServerStatus', null, app.getServerId(), load);
	}).catch(function(e){
