	...
	return Q.fcall(function(){
		...
		if(self._flush > 0){
			self.flushInterval = setInterval(function(){
				...
				self.app.areaManager.invokeArea(self._id, 'save').catch(function(e){
					logger.warn(e.stack);
				});
			}, self._flush);
		}
...
proto.save = function(){
	return this.app.areaManager.saveArea(this);
};
...
proto.join = function(playerId){
	...
	return Q.fcall(function(){
		...
		return Q.fcall(function(){
			...
			return self.app.playerManager.releasePlayer(playerId, self._id).catch(function(e){
				logger.warn(e.stack);
			}).then(function(){
				throw e;
			});
